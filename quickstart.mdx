...
<Note>
  App Store releases require a build ID, a metadata directory, and `--confirm`: `asc release run --app "123456789" --version "1.2.3" --build "BUILD_ID" --metadata-dir "./metadata/version/1.2.3" --confirm`
</Note>
